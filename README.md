...
* As a user, I want to navigate the website easily so I can find the information I need.
* As a user, I want the website to work on mobile, tablet, and desktop so I can view it on any device.
* As a user, I want clear sections (Home, Gallery, About, Contact) so I can understand the structure of the site.

#### Should Have

* As a user, I want the gallery images to be displayed in a clean and organised layout so I can enjoy browsing them.

#### Could Have

* As a user, I want the navigation bar to remain visible at the top of the page while I scroll, so I can access the menu at any time.
...
2. Selected Pages.
3. Chose the main branch and root folder.
4. GitHub generated the live site link.
...
6. [gallery boquet img1](https://unsplash.com/photos/person-holding-beige-and-white-flower-bouquet-aiNU4cA4UzQ)
7. [gallery bouquet img2](https://unsplash.com/photos/bouquet-of-of-roses-01Wa3tPoQQ8)
8. [gallery bouquet img3](https://unsplash.com/photos/white-ice-cream-on-white-ceramic-bowl-Vxm213warDA)
9. [gallery bouquet img4](https://unsplash.com/photos/a-white-cake-with-flowers-on-top-39UfaHtPxnY)
10. [gallery-roses-img1](https://unsplash.com/photos/a-close-up-of-some-flowers-KHteWIDh148)
11. [gallery roses img2](https://unsplash.com/photos/a-close-up-of-a-bunch-of-flowers-on-a-table-lByb1JKS2e0)
12. [gallery roses img3](https://unsplash.com/photos/a-close-up-of-a-red-rose-with-a-blurry-background-QvZlev6ifBI)
12. [gallery roses img4](https://unsplash.com/photos/a-vase-filled-with-pink-roses-on-top-of-a-table-G4jxUWUNJDc)
13. [gallery seasonal img1](https://unsplash.com/photos/colorful-chrysanthemum-flowers-in-full-bloom-ESu0kxH3S3U)
14. [gallery seasonal img2](https://unsplash.com/photos/orange-and-yellow-chrysanthemums-bloom-together-N-lRKHjfEn0)
